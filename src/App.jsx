                        ...
                        {isMobile && (
                          <>
                            ...
                            <RichEditableField
                              ...
                              className="block"
                              style={{ ...exhibitionLocationStyle, color: "rgba(0, 0, 0, 0.5)", overflowWrap: "break-word" }}
                      ...
                      {(section.entries || []).map((entry) => {
                        ...
                        return (
                          <div
                            key={entry.id}
                            className="grid"
                            style={{ gridTemplateColumns: "3.5rem minmax(0, 1fr)", columnGap: "0.25em", rowGap: "2px" }}
                          >
                            ...
                            {entryParts.location && (
                              <>
                                <span aria-hidden="true" />
                                <span
                                  style={{ ...exhibitionLocationStyle, color: "rgba(0, 0, 0, 0.5)", lineHeight: 1.3 }}
                                  lang={exhibitionLocationLang}
